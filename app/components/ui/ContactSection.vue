    ...
    <div class="flex">
      ...
      >
        ...
        <div v-else>
          ...
          <div
            class="hidden lg:grid grid-cols-2 lg:grid-cols-6 gap-16 lg:gap-16 fade-in-left"
          ...
          >
            ...
            <div
              class="lg:col-span-3 flex flex-col justify-between gap-8 font-extralight"
              :style="`font-size: clamp(${Math.max(
                18,
                Math.round(37 * 0.35)
            ...
            <div
              class="col-span-2 lg:col-span-1 flex flex-row lg:flex-col gap-1 justify-between items-start"
            >
              <!-- Instagram -->
              <a
          ...
          <!-- Mobile -->
          <div
            class="grid lg:hidden grid-cols-5 lg:grid-cols-6 gap-16 lg:gap-16 fade-in-left"
            style="animation-delay: 0.15s"
          >
            <!-- Options + Year -->
            <div class="flex flex-col justify-between gap-6">
              ...
              >
                <button
                  ...
                  @click="toggleTheme"
                >
                  <img src="/icons/general/Artboard1.svg" width="25" />
                </button>
                <button
                  class="flex justify-start items-center gap-2"
                  id="toggle-lang"
                  ...
                  :class="locale === 'ar' ? 'font-en' : 'font-ar'"
                >
                  <img src="/icons/general/Artboard2.svg" width="25" />
                  <span
            ...
            <!-- Contact Information List -->
            <div
              class="col-span-4 flex flex-row justify-between gap-8 font-extralight"
              :style="`font-size: clamp(${Math.max(
                14,
                Math.round(37 * 0.35)
              )}px, ${(37 / 20).toFixed(1)}vw, ${37}px);`"
            >
              ...
              <div flex flex-col justify-between gap-8>
                ...
                <div>
                  ...
                  <p
                    class="text-white font-en rtl:text-right text-nowrap"
                    dir="ltr"
                  >
                    {{ $t("contact.vat") }}:
                    <bdi>{{ settings?.vat_number }}</bdi>
                  </p>
                </div>
              </div>
            ...
            <div class="col-span-5 grid grid-cols-2 gap-4 items-center">
              ...
              <!-- Social Media -->
              <div
                class="w-full flex flex-row lg:flex-col gap-1 justify-between items-start"
              >
                <!-- Social Media Icons (Vertical Stack) -->
                <!-- Instagram -->
                <a
